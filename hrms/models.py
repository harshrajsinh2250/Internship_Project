...
class Employee(models.Model):
    LANGUAGE = (('english', 'ENGLISH'), ('gujarati', 'GUJARATI'), ('hindi', 'HINDI'), ('marathi', 'MARATHI'))
    ...
    nuban = models.CharField(max_length=10, default='Employee')
    bank = models.CharField(max_length=25, default='BizAppDev Systems')
